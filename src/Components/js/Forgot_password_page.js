  ...
  async function emailSend() {
    ...
    .then(function (response) {
      ...
      if (response.data.status == 200) {
        ...
        Navigate("/Verify_Email_page" ,{state:{dataOtp:(response.data.data.code)}});
      } else {
  ...
  return (
    <>
       {/* <ToastContainer /> */}
        ...
        <Link to="/Sign_in_page">   <img src={Back_Arrow}></img> </Link>
        </div>
        <div className="mainContent">
          <div className="ForgotPasswordText">
            <h1>Forgot Password</h1>
            <p>You’ll receive 04 digit code to verify
email.</p>
          </div>
          <div className="form">
            <div class="yourEmail">
